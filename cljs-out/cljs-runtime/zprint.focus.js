...
var G__26333 = new_next_nonws_QMARK_;
index = G__26331;
skip_to_right_QMARK_ = G__26332;
next_nonws_QMARK_ = G__26333;
continue;
}
}
break;
...
var G__26338 = zprint.focus.next_ssv(ssv,index);
var G__26339 = (moves - (1));
index = G__26338;
moves = G__26339;
continue;
}
...
var G__26340 = zprint.focus.right_ssv(cljs.core.first(nwp),ssv,zprint.focus.down_ssv(ssv,idx));
var G__26341 = cljs.core.next(nwp);
idx = G__26340;
nwp = G__26341;
continue;
}
...
})())?(function (){var fexpr__26328 = cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.dec,(1));
return (fexpr__26328.cljs$core$IFn$_invoke$arity$1 ? fexpr__26328.cljs$core$IFn$_invoke$arity$1(ssv_next) : fexpr__26328.call(null,ssv_next));
