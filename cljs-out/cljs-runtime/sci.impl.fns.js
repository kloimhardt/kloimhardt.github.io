...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__26339,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__26340__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26340__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26340__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26340__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26340__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__26383 = cljs.core.next(args__$1);
var G__26384 = cljs.core.next(params__$1);
var G__26385 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__26383;
params__$1 = G__26384;
ret = G__26385;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__26342 = ctx__$1;
var G__26343 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__26342,G__26343) : interpret.call(null,G__26342,G__26343));
...
if(recur_QMARK_){
var G__26386 = sci.impl.types.getVal(ret);
args = G__26386;
continue;
} else {
return ret;
...
while (G__26387__i < G__26387__a.length) {G__26387__a[G__26387__i] = arguments[G__26387__i + 0]; ++G__26387__i;}
  args = new cljs.core.IndexedSeq(G__26387__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__26388){
var args = cljs.core.seq(arglist__26388);
...
var map__26344 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26344__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26344__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__26354){
var map__26355 = p__26354;
var map__26355__$1 = (((((!((map__26355 == null))))?(((((map__26355.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26355.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26355):map__26355);
var f = map__26355__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26355__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26355__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__26396__i < G__26396__a.length) {G__26396__a[G__26396__i] = arguments[G__26396__i + 0]; ++G__26396__i;}
  args = new cljs.core.IndexedSeq(G__26396__a,0,null);
} 
...
var args = cljs.core.seq(arglist__26397);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26349_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__26349_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__26353_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__26353_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
