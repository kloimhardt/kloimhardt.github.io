...
var G__27239 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__27239__$1 = (((G__27239 == null))?null:cljs.core.iterate((function (loc){
...
var G__27239__$2 = (((G__27239__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27239__$1));
var G__27239__$3 = (((G__27239__$2 == null))?null:cljs.core.last(G__27239__$2));
if((G__27239__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__27239__$3);
}
} else {
return zloc;
}
...
var G__27244 = rewrite_clj.zip.move.right(v);
var G__27245 = rewrite_clj.zip.move.up(v);
loc = G__27244;
parent = G__27245;
continue;
} else {
var G__27246 = rewrite_clj.zip.move.right(v0);
var G__27247 = parent;
loc = G__27246;
parent = G__27247;
continue;
...
var G__27248 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__27249 = rewrite_clj.zip.move.up(v);
loc = G__27248;
parent = G__27249;
continue;
} else {
var G__27250 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__27251 = parent;
loc = G__27250;
parent = G__27251;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__27242 = zloc;
var G__27242__$1 = (((G__27242 == null))?null:rewrite_clj.zip.move.down(G__27242));
var G__27242__$2 = (((G__27242__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__27242__$1,k));
if((G__27242__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__27242__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__27243 = rewrite_clj.zip.move.down(zloc);
var G__27243__$1 = (((G__27243 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__27243));
if((G__27243__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__27243__$1);
}
})(),k);
}
});
