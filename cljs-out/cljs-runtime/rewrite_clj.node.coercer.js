...
var G__26937_26952 = rewrite_clj.node.protocols.coerce;
var G__26938_26953 = "object";
var G__26939_26954 = (function (v){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(v),v);
});
goog.object.set(G__26937_26952,G__26938_26953,G__26939_26954);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"number",true);

var G__26940_26955 = rewrite_clj.node.protocols.coerce;
var G__26941_26956 = "number";
var G__26942_26957 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.token.token_node.cljs$core$IFn$_invoke$arity$1(n),n);
});
goog.object.set(G__26940_26955,G__26941_26956,G__26942_26957);
goog.object.set(rewrite_clj.node.protocols.NodeCoerceable,"string",true);

var G__26943_26958 = rewrite_clj.node.protocols.coerce;
var G__26944_26959 = "string";
var G__26945_26960 = (function (n){
return rewrite_clj.node.coercer.node_with_meta(rewrite_clj.node.stringz.string_node(n),n);
});
goog.object.set(G__26943_26958,G__26944_26959,G__26945_26960);
rewrite_clj.node.coercer.seq_node = (function rewrite_clj$node$coercer$seq_node(f,sq){
return rewrite_clj.node.coercer.node_with_meta((function (){var G__26947 = cljs.core.vec(rewrite_clj.node.whitespace.space_separated(cljs.core.map.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.coerce,sq)));
...
var comma_26961 = rewrite_clj.node.whitespace.whitespace_node(", ");
var space_26962 = rewrite_clj.node.whitespace.whitespace_node(" ");
rewrite_clj.node.coercer.map__GT_children = (function rewrite_clj$node$coercer$map__GT_children(m){
return cljs.core.vec(cljs.core.butlast(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__26948){
var vec__26949 = p__26948;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26949,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26949,(1),null);
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [rewrite_clj.node.protocols.coerce(k),space_26962,rewrite_clj.node.protocols.coerce(v),comma_26961], null);
