...
var vec__28587 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__28590 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28590,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28590,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28587,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28587,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__28596){
var vec__28597 = p__28596;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28597,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28597,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28600,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28600,(1),null);
...
var vec__28604 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28604,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28604,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28604,(2),null);
var vec__28607 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28607,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28607,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28607,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__28617){
var vec__28618 = p__28617;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28618,(1),null);
...
var len__4789__auto___28669 = arguments.length;
var i__4790__auto___28670 = (0);
while(true){
if((i__4790__auto___28670 < len__4789__auto___28669)){
args__4795__auto__.push((arguments[i__4790__auto___28670]));

var G__28671 = (i__4790__auto___28670 + (1));
i__4790__auto___28670 = G__28671;
continue;
} else {
}
break;
...
var vec__28624 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28624,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28624,(1),null);
...
var G__28627 = zprint.core.parse_string_all_options(rest_options);
var G__28628 = zprint.core.zprint_str_internal;
var G__28629 = ":parse-string-all? call";
var G__28630 = (function (){var G__28631 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__28631) : zprint.zutil.edn_STAR_.call(null,G__28631));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__28627,G__28628,G__28629,G__28630) : zprint.core.process_multiple_forms.call(null,G__28627,G__28628,G__28629,G__28630));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__28632 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28632,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq28621){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28622,G__28623,seq28621__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___28674 = arguments.length;
var i__4790__auto___28675 = (0);
while(true){
if((i__4790__auto___28675 < len__4789__auto___28674)){
args__4795__auto__.push((arguments[i__4790__auto___28675]));

var G__28676 = (i__4790__auto___28675 + (1));
i__4790__auto___28675 = G__28676;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq28637){
var G__28638 = cljs.core.first(seq28637);
var seq28637__$1 = cljs.core.next(seq28637);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28638,seq28637__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___28677 = arguments.length;
var i__4790__auto___28679 = (0);
while(true){
if((i__4790__auto___28679 < len__4789__auto___28677)){
args__4795__auto__.push((arguments[i__4790__auto___28679]));

var G__28680 = (i__4790__auto___28679 + (1));
i__4790__auto___28679 = G__28680;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq28639){
var G__28640 = cljs.core.first(seq28639);
var seq28639__$1 = cljs.core.next(seq28639);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28640,seq28639__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___28681 = arguments.length;
var i__4790__auto___28682 = (0);
while(true){
if((i__4790__auto___28682 < len__4789__auto___28681)){
args__4795__auto__.push((arguments[i__4790__auto___28682]));

var G__28683 = (i__4790__auto___28682 + (1));
i__4790__auto___28682 = G__28683;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq28641){
var G__28642 = cljs.core.first(seq28641);
var seq28641__$1 = cljs.core.next(seq28641);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28642,seq28641__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___28684 = arguments.length;
var i__4790__auto___28685 = (0);
while(true){
if((i__4790__auto___28685 < len__4789__auto___28684)){
args__4795__auto__.push((arguments[i__4790__auto___28685]));

var G__28686 = (i__4790__auto___28685 + (1));
i__4790__auto___28685 = G__28686;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq28643){
var G__28644 = cljs.core.first(seq28643);
var seq28643__$1 = cljs.core.next(seq28643);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28644,seq28643__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__28646,form){
var vec__28647 = p__28646;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28647,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__28650 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28650,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28650,(1),null);
...
var forms = (function (){var G__28658 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__28658) : zprint.zutil.edn_STAR_.call(null,G__28658));
})();
