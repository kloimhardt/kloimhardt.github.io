...
if((c === "\n")){
var G__26990 = escape_QMARK_;
var G__26991 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__26990;
lines = G__26991;
continue;
} else {
buf.append(c);

var G__26992 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__26993 = lines;
escape_QMARK_ = G__26992;
lines = G__26993;
continue;
...
var G__26985 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__26985) : rewrite_clj.node.string_node.call(null,G__26985));
});
...
var G__26986 = cljs.core.re_pattern(regex);
var G__26987 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__26986,G__26987) : rewrite_clj.node.token_node.call(null,G__26986,G__26987));
});
