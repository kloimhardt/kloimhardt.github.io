...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k26845,else__4442__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__26856){
var vec__26857 = p__26856;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26857,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26857,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__26844){
var self__ = this;
var G__26844__$1 = this;
return (new cljs.core.RecordIter((0),G__26844__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this26846,other26847){
var self__ = this;
var this26846__$1 = this;
return (((!((other26847 == null)))) && ((this26846__$1.constructor === other26847.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.tag,other26847.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.wrap_fn,other26847.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.wrap_length,other26847.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.seq_fn,other26847.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.children,other26847.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this26846__$1.__extmap,other26847.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__26866 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__26866) : self__.seq_fn.call(null,G__26866));
}));
...
var self__ = this;
var this$__$1 = this;
var G__26872 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__26872) : self__.wrap_fn.call(null,G__26872));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__26844){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__26873 = cljs.core.keyword_identical_QMARK_;
var expr__26874 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__26876 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
...
return (new rewrite_clj.node.seq.SeqNode(G__26844,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26878 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__26844,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26880 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__26844,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26882 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__26844,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__26884 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__26885 = expr__26874;
return (pred__26873.cljs$core$IFn$_invoke$arity$2 ? pred__26873.cljs$core$IFn$_invoke$arity$2(G__26884,G__26885) : pred__26873.call(null,G__26884,G__26885));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__26844,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__26844),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__26844){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__26844,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__26848){
var extmap__4478__auto__ = (function (){var G__26892 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__26848,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__26848)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__26892);
} else {
return G__26892;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__26848),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__26848),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__26848),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__26848),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__26848),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__26893_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__26893_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__26894_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__26894_SHARP_);
}),children);
});
