...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__26330_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__26330_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__26330_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__26334){
var vec__26335 = p__26334;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26335,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26335,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__26343,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26344__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26344__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26344__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__26368 = (function (){var or__4185__auto__ = color;
...
var fexpr__26367 = (function (){var G__26369 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__26369) : style_map.call(null,G__26369));
})();
return (fexpr__26367.cljs$core$IFn$_invoke$arity$1 ? fexpr__26367.cljs$core$IFn$_invoke$arity$1(G__26368) : fexpr__26367.call(null,G__26368));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__26371){
var vec__26372 = p__26371;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26372,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26372,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26372,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__26377){
var vec__26378 = p__26377;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26378,(2),null);
...
var G__26544 = cljs.core.next(ssv);
var G__26545 = (this_ssv == null);
var G__26546 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__26547 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__26544;
doing_nil_QMARK_ = G__26545;
last_elide = G__26546;
out = G__26547;
continue;
}
...
var vec__26396 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26396,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26396,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26396,(2),null);
...
var G__26565 = cljs.core.next(remaining_cvec);
var G__26566 = new_idx;
var G__26567 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__26565;
idx = G__26566;
out = G__26567;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__26445,cursor_vec){
var vec__26449 = p__26445;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26449,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26449,(1),null);
var focus_vec = vec__26449;
...
var vec__26452 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26452,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26452,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__26455){
var vec__26456 = p__26455;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26456,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26456,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__26479,existing_count){
var vec__26480 = p__26479;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26480,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26480,(1),null);
...
return cljs.core.filterv((function (p1__26475_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__26475_SHARP_))));
...
var vec__26499 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26499,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26499,(1),null);
var cvec_element = vec__26499;
if((cvec_element == null)){
var G__26606 = cljs.core.next(cvec_nl);
var G__26607 = (idx + (1));
var G__26608 = start;
var G__26609 = out;
cvec_nl = G__26606;
...
var G__26610 = cljs.core.next(cvec_nl);
var G__26611 = (idx + (1));
var G__26612 = idx;
var G__26613 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__26610;
idx = G__26611;
start = G__26612;
out = G__26613;
...
var G__26614 = cljs.core.next(cvec_nl);
var G__26615 = (idx + (1));
var G__26616 = (idx + (1));
var G__26617 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__26614;
idx = G__26615;
start = G__26616;
out = G__26617;
...
var G__26618 = cljs.core.next(cvec_nl);
var G__26619 = (idx + (1));
var G__26620 = idx;
var G__26621 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__26618;
idx = G__26619;
start = G__26620;
out = G__26621;
...
var G__26622 = cljs.core.next(cvec_nl);
var G__26623 = (idx + (1));
var G__26624 = start;
var G__26625 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__26622;
idx = G__26623;
start = G__26624;
out = G__26625;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__26505_SHARP_,p2__26504_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__26504_SHARP_)){
return cljs.core.reduced(p1__26505_SHARP_);
} else {
return (p1__26505_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__26506,p__26507){
var vec__26508 = p__26506;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26508,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26508,(1),null);
var vec__26511 = p__26507;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26511,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26511,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__26517,cvec,focus_vec){
...
var options = map__26518__$1;
var map__26519 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26518__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__26519__$1 = (((((!((map__26519 == null))))?(((((map__26519.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26519.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__26519):map__26519);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26519__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26519__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26519__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__26514_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__26514_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
