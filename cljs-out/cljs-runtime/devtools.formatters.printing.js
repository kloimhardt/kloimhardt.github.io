...
var len__4789__auto___29878 = arguments.length;
var i__4790__auto___29879 = (0);
while(true){
if((i__4790__auto___29879 < len__4789__auto___29878)){
args__4795__auto__.push((arguments[i__4790__auto___29879]));

var G__29880 = (i__4790__auto___29879 + (1));
i__4790__auto___29879 = G__29880;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29784){
var G__29785 = cljs.core.first(seq29784);
var seq29784__$1 = cljs.core.next(seq29784);
var G__29786 = cljs.core.first(seq29784__$1);
var seq29784__$2 = cljs.core.next(seq29784__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29785,G__29786,seq29784__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29798_SHARP_){
return (!((cljs.core.meta(p1__29798_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29800__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29804){var _e__26766__auto__ = e29804;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e29806){var _e__26766__auto__ = e29806;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29808 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29809 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29809);

try{var map__29810 = opts;
var map__29810__$1 = (((((!((map__29810 == null))))?(((((map__29810.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29810.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29810):map__29810);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29810__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29808);
}});
...
var temp__5733__auto___29903 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29903)){
var managed_print_level_29904 = temp__5733__auto___29903;
var _STAR_print_level_STAR__orig_val__29849_29905 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29850_29906 = managed_print_level_29904;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29850_29906);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29842_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29842_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29849_29905);
}} else {
job_fn();
}
