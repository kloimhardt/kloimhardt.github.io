...
var G__27485 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__27485;
continue;
} else {
var G__27486 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__27486;
continue;
}
} else {
var G__27487 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__27487;
continue;
}
}
...
var G__27442 = zloc;
var G__27443 = (function (){var G__27444 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__27445 = zloc;
var G__27445__$1 = (((G__27445 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__27445) : rewrite_clj.zip.node.call(null,G__27445)));
if((G__27445__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__27445__$1) : zprint.zutil.edn_STAR_.call(null,G__27445__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__27444) : rewrite_clj.zip.root.call(null,G__27444));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__27442,G__27443) : rewrite_clj.zip.replace.call(null,G__27442,G__27443));
});
/**
...
var G__27499 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__27499;
continue;
}
break;
...
var G__27500 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__27501 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__27500;
out = G__27501;
continue;
} else {
...
var G__27506 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__27507 = cljs.core.next(new_loc);
var G__27508 = replaced_loc;
nloc = G__27506;
new_loc = G__27507;
last_loc = G__27508;
continue;
...
return zprint.rewrite.sort_val((function (){var G__27460 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__27460) : rewrite_clj.zip.down.call(null,G__27460));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__27461_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__27461_SHARP_) : rewrite_clj.zip.tag.call(null,p1__27461_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__27461_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__27461_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
