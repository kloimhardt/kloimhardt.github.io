...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__27164,k,f){
var vec__27165 = p__27164;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27165,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27165,(1),null);
var loc = vec__27165;
...
var G__27211 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__27211;
continue;
}
break;
...
var G__27212 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__27212;
continue;
} else {
return zloc__$1;
...
var G__27213 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__27213;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__27181){
var vec__27182 = p__27181;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27182,(0),null);
var map__27185 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27182,(1),null);
...
var path = map__27185__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27185__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__27182;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__27188){
var vec__27189 = p__27188;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27189,(0),null);
var map__27192 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27189,(1),null);
...
var path = map__27192__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27192__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__27189;
if(cljs.core.seq(r)){
...
var map__27197 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27194,(1),null);
...
var path = map__27197__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27197__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27197__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27197__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27197__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
